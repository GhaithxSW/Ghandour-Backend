        ...
        <ul class="navbar-item theme-brand flex-row text-center">
            <li class="nav-item theme-logo theme-logo-new">
                <a href="/dashboard/home">
                    <img src="{{ asset('/images/ghandour.png') }}" class="navbar-logo" alt="LOGO"
                         style="height: 50px">
                </a>
            </li>
            <li class="nav-item theme-text them-text-new">
                <a href="/dashboard/home" class="nav-link" style="font-size: 20px"> <b>غندور</b> </a>
            </li>
        </ul>
            ...
            @if(auth()->check())
                ...
                <li class="nav-item theme-toggle-item theme-auth-new">
                    <form method="POST" action="/dashboard/logout">
                        @csrf
                        <x-dropdown-link href="/dashboard/logout"
                ...
                <li class="nav-item theme-toggle-item theme-auth-new">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-login-2" width="24"
                            ...
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path
                                d="M9 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2"></path>
